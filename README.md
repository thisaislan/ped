...
<h4 align="center" style="text-align:center;">
  ...
  <a href="https://github.com/thisaislan/persistence-easy-to-delete">
    <img src="https://github.com/thisaislan/just-images/raw/main/images/ped/logo.png">
  </a>

  ![Hi!](https://github.com/thisaislan/just-images/raw/main/images/ped/alex_and_theo.png)

  <!-- 
    Meet Alex and Theo : D
    That duo was my first pixel art.
    Me and a friend of mine were thinking about working on a game together, but the project didn't go ahead. :(
    The idea was a platform game, with a puzzle, dealing with some feelings growing up, and maybe, just maybe, some survival elements.
    If you noticed some influences...yeah, more than influences maybe...it's not a coincidence I LOVE that experience..S2
  -->
...
<!-- 
  By the way, if you made it this far, thank you very much and I really hope this project can help you a lot!
  :D
-->